          ...
          <Col xs={this.state.ContentAlignment.Middle}>
            <div>
              <p style={{marginTop: "2rem"}}>
                ...
                I am currently a Software Intern for <a className="underLine" href="https://www.ibm.com/us-en/?ar=1">IBM </a> in <a className="underLine" href="#">San Jose, California</a> and 
